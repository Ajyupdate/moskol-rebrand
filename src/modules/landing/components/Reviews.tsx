    ...
    //   width={'full'}
      ...
      <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
        ...
        <chakra.h2
          ...
          See why over a lot of institutions and companies partner with us for their energy and security work
        </chakra.h2>
      </Box>
      <SimpleGrid columns={{ base: 1, xl: 2 }} spacing={'5'} mt={16} mb={16} mx={{md: 24, base: 8}}>
        {Reviews && Reviews.map((cardInfo, index) => (
      ...
      >
      <Flex direction={'column'} textAlign={'left'} justifyContent={'space-between'}>
        <chakra.p bg={'white'} fontFamily={'Inter'} fontWeight={'medium'} fontSize={'15px'} pb={4}>
          {cardInfo.comment}
        </chakra.p>
        <chakra.p fontFamily={'Work Sans'} fontWeight={'bold'} fontSize={14}>
          {cardInfo.name}
